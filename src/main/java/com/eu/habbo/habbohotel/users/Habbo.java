...
public class Habbo implements Runnable {
    ...
    public boolean connect() {
        ...
        LOGGER.info("{} entrou no hotel com o IP {}", this.habboInfo.getUsername(), this.habboInfo.getIpLogin());
    ...
    public synchronized void disconnect() {
        ...
        try {
            if (this.getHabboInfo().getCurrentRoom() != null) {
                this.talk("* " + this.getHabboInfo().getUsername() + " está saindo do RP*", RoomChatMessageBubbles.ALERT);

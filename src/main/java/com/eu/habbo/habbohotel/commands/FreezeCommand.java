        ...
        if (params.length == 2) {
            ...
            if (habbo == null) {
                ...
                if (habbo.getRoomUnit().canWalk()) {
                    ...
                    habbo.getHabboInfo().getCurrentRoom().giveEffect(habbo, 12, -1);

                    gameClient.getHabbo().talk("* Congela " + params[1] + " *", RoomChatMessageBubbles.STAFF);
                    ...
                    gameClient.getHabbo().talk("* Descongela " + params[1] + " *", RoomChatMessageBubbles.STAFF);

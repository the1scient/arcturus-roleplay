...
public class DarkRankCommand extends Command {
    public DarkRankCommand() {
        ...
        if (params.length == 3) {
            ...
            if (rank != null) {
                ...
                if (habbo != null) {
                    ...
                    gameClient.getHabbo().talk("* Altera imediatamente o cargo de " + params[1] + " para  [Rank ID: " + rank.getId() + "] *", RoomChatMessageBubbles.STAFF);
